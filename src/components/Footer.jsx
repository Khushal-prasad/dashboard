...
function Footer() {
    return (
        <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20 font-["Founders Grotesk"] text-zinc-200'>
            <div className='w-1/2 flex flex-col justify-between h-full'>
                <div className='heading'>
                    <h1 className='text-[6vw] font-semibold leading-none uppercase -mb-18 tracking-tighter'>EYE-</h1>
                    <h1 className='text-[6vw] font-semibold leading-none uppercase -mb-10 tracking-tighter'>OPENING</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[6vw] font-semibold leading-none uppercase -mb-18 tracking-tighter'>PRESENTATIONS</h1>
                <div className='dets font-[Neue Montreal] ml-[1vw] mt-[17vw] flex flex-col gap-5'>
                    <h1 className='text-[1vw] font-bold'>Our Socials:</h1>
                    {["instagram", "facebook", "behance", "linkdin"].map((items, index) =>
                        (<a className='underline font-light capitalize text-md font-regular block hover:text-white' key={index}>{items}</a>))}</div>
                        <div className='ml-[35vw] mt-10'><h1>website by ochi</h1></div>
            </div>
